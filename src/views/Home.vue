    ...
    <div class="pl-8 w-full bg-white">
      <div class="relative mx-auto pt-16 px-16 max-w-screen-xl text-blue">
        ...
        <div class="relative py-8">
          ...
          <p class="py-2">Some components are included to add an additional challenge to the game and increase engagement with the players. The first component included is an <strong>octopus</strong> that will be around a receiving player, and a throwing player will lose a live if a pass is connected to this player. Another component included are the <strong>jellyfishes</strong> that will be projected on at random spots in the water surface, and if the ball pass across them the throwing player will lose a live. Besides blocking sea creatures, the game may project randomly <strong>sea otters</strong> as distraction for the players. The last component included in the game are <strong>submarines</strong>, which will appear randomly inside of the circle and if a player hits it with the ball a live will be added. Also when the submarine appears outside of the circle any player without lives can catch it to restore their lives and continue with the normal game.</p>
        </div>
